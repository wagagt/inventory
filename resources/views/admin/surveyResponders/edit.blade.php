...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.surveyResponder.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.survey-responders.update", [$surveyResponder->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="names">{{ trans('cruds.surveyResponder.fields.names') }}</label>
                <input class="form-control {{ $errors->has('names') ? 'is-invalid' : '' }}" type="text" name="names" id="names" value="{{ old('names', $surveyResponder->names) }}">
                @if($errors->has('names'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_names') ? 'is-invalid' : '' }}" type="text" name="last_names" id="last_names" value="{{ old('last_names', $surveyResponder->last_names) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identification') ? 'is-invalid' : '' }}" type="text" name="identification" id="identification" value="{{ old('identification', $surveyResponder->identification) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $surveyResponder->email) }}">
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dob') ? 'is-invalid' : '' }}" type="text" name="dob" id="dob" value="{{ old('dob', $surveyResponder->dob) }}">
                @if($errors->has('dob'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company') ? 'is-invalid' : '' }}" type="text" name="company" id="company" value="{{ old('company', $surveyResponder->company) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('position') ? 'is-invalid' : '' }}" type="text" name="position" id="position" value="{{ old('position', $surveyResponder->position) }}">
