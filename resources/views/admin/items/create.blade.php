    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.items.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transaction_detail') ? 'is-invalid' : '' }}" type="number" name="transaction_detail" id="transaction_detail" value="{{ old('transaction_detail', '') }}" step="1">
