    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('internal_code') ? 'is-invalid' : '' }}" type="text" name="internal_code" id="internal_code" value="{{ old('internal_code', $product->internal_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_stock') ? 'is-invalid' : '' }}" type="number" name="max_stock" id="max_stock" value="{{ old('max_stock', $product->max_stock) }}" step="1">
