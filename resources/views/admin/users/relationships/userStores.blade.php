    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-userStores">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($stores as $key => $store)
                            <tr data-entry-id="{{ $store->id }}">
                                ...
                                <td>
                                    @foreach($store->users as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-userStores:not(.ajaxTable)').DataTable({ buttons: dtButtons })
